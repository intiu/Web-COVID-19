// TẤT CẢ CÁC TÊN QUỐC GIA CÓ MÃ ISO CỦA HỌ
let country_list = [
    { name: 'USA', code: 'US' },
    { name: 'Spain', code: 'ES' },
    { name: 'Italy', code: 'IT' },
...
// CHỌN CÁC PHẦN TỬ CỦA QUỐC GIA TÌM KIẾM
...
// HIỂN THỊ / Ẩn DANH SÁCH QUỐC GIA TRÊN BẤM VÀO SỰ KIỆN
...
// BỘ LỌC NƯỚC
/* sự kiện đầu vào kích hoạt bất cứ khi nào giá trị của đầu vào thay đổi */
...
// ĐẶT LẠI DANH SÁCH QUỐC GIA (HIỂN THỊ TẤT CẢ CÁC QUỐC GIA)
